...
import com.bluecity.cbs.common.config.Constant;
import com.bluecity.cbs.common.domain.ColumnDO;
import com.bluecity.cbs.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        tableDO.setClassNameLowerCase(StringUtils.uncapitalize(className));
        ...
        map.put("classname", tableDO.getClassNameLowerCase());
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassNameLowerCase(), tableDO.getClassName(), config.getString("package").substring(config.getString("package").lastIndexOf(".") + 1))));
